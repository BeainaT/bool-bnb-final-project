<form action="{{route('user.messages.destroy', $message->id)}}" method="POST" enctype="multipart/form-data">
    {{ method_field('delete')}}
    {{ csrf_field() }}
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">{{ __("Confermi l'eliminazione del messaggio di ".$message->sender_name."?") }}</h4>
